...
1.	Sample code for removing Ambient RNA for individual samples before qc using SoupX: “SoupX.Rmd” and “SoupX.pdf”. Please note the input file for SoupX is the “outs” folder from Cellranger alignment, it will scan and read files needed from this folder.
2.	Sample code for qc of individual samples to remove potential low quality cells, dead cells and potential multiplets:” QC CM1_2.pdf” and “qc_CM1_2.Rmd”.
